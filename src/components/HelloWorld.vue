  ...
  methods: {
    ...
    addTextOverlay(bannerHeight) {
      if (!this.nameText || !this.courseText) {
        this.nameText = new fabric.Textbox(
          this.details.name || "Full Name",  
          {
        ...
        this.courseText = new fabric.Textbox(
          this.details.course || "Course",  
          {
            left: this.canvas.width / 2,
    ...
    addLineDivider() {
      const divider = new fabric.Line([
        this.canvas.width / 4, this.canvas.height - 60, 
        3 * this.canvas.width / 4, this.canvas.height - 60
      ], {
        stroke: "#ffffff",      
        strokeWidth: 2,      
        selectable: false,   
